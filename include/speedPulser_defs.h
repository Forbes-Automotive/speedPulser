...
// ===== Motor Direction & Closed-Loop Feedback (defined in speedPulser_defs.cpp) =====
extern bool reverseDirection;            // UI toggle; drives pinDirection LOW to reverse
...
#define pinDirection 10   // motor direction pin: LOW reverses the motor, HIGH = forward
